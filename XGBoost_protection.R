...
my_comprisons=list(c("nAMS4k","nAMS1k"))
...
p_clinic +theme(axis.title= element_text(size=14,  color="black", face= "bold"))+
  ...
  labs(title="Clinical indexes importance" )
dev.off()
...
pdf(file = paste(paste(my_comprisons[[1]],collapse = "_vs_"),"_ROC_20210810.pdf",sep = ""),
    width = 5.5, height = 5.5)

plot(xgb.ROC_MRM, main= "Protection ROC curve", lwd=3 , col= "#F3574A")
